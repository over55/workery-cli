...
func (impl HowHearAboutUsItemStorerImpl) newPaginationFilter(f *HowHearAboutUsItemPaginationListFilter) (bson.M, error) {
	if len(f.Cursor) > 0 {
...
func (impl HowHearAboutUsItemStorerImpl) newPaginationFilterBasedOnString(f *HowHearAboutUsItemPaginationListFilter, decodedCursor string) (bson.M, error) {
...
func (impl HowHearAboutUsItemStorerImpl) newPaginationFilterBasedOnInt8(f *HowHearAboutUsItemPaginationListFilter, decodedCursor string) (bson.M, error) {
	// Extract our cursor into two parts which we need to use.
	arr := strings.Split(decodedCursor, "|")
	if len(arr) < 1 {
		return nil, fmt.Errorf("cursor is corrupted for the value `%v`", decodedCursor)
...
func (impl HowHearAboutUsItemStorerImpl) newPaginationFilterBasedOnTimestamp(f *HowHearAboutUsItemPaginationListFilter, decodedCursor string) (bson.M, error) {
	// Extract our cursor into two parts which we need to use.
	arr := strings.Split(decodedCursor, "|")
	if len(arr) < 1 {
		return nil, fmt.Errorf("cursor is corrupted for the value `%v`", decodedCursor)
...
func (impl HowHearAboutUsItemStorerImpl) newPaginationOptions(f *HowHearAboutUsItemPaginationListFilter) (*options.FindOptions, error) {
...
// with our paginator.
func (impl HowHearAboutUsItemStorerImpl) newPaginatorNextCursor(f *HowHearAboutUsItemPaginationListFilter, results []*HowHearAboutUsItem) (string, error) {
	var lastDatum *HowHearAboutUsItem
