...
func (impl AssociateStorerImpl) ListByFilter(ctx context.Context, f *AssociateListFilter) (*AssociateListResult, error) {
	...
	if f.ExcludeArchived {
		filter["status"] = bson.M{"$ne": AssociateStatusArchived} // Do not list archived items! This code
	}
	if f.Status != 0 {
