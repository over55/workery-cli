...
func (impl VehicleTypeStorerImpl) ListByFilter(ctx context.Context, f *VehicleTypeListFilter) (*VehicleTypeListResult, error) {
...
func (impl VehicleTypeStorerImpl) ListAsSelectOptionByFilter(ctx context.Context, f *VehicleTypeListFilter) ([]*VehicleTypeAsSelectOption, error) {
	ctx, cancel := context.WithTimeout(context.Background(), 12*time.Second)
	defer cancel()
