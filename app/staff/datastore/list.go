...
func (impl StaffStorerImpl) ListByFilter(ctx context.Context, f *StaffListFilter) (*StaffListResult, error) {
	...
	if f.ExcludeArchived {
		filter["status"] = bson.M{"$ne": StaffStatusArchived} // Do not list archived items! This code
	}
	if f.Status != 0 {
