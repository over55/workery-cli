...
func (impl SkillSetStorerImpl) ListByFilter(ctx context.Context, f *SkillSetListFilter) (*SkillSetListResult, error) {
	...
	if f.ExcludeArchived {
		filter["status"] = bson.M{"$ne": SkillSetStatusArchived} // Do not list archived items! This code
	}
	if f.Status != 0 {
...
func (impl SkillSetStorerImpl) ListAsSelectOptionByFilter(ctx context.Context, f *SkillSetListFilter) ([]*SkillSetAsSelectOption, error) {
	...
	if f.ExcludeArchived {
		query["status"] = bson.M{"$ne": SkillSetStatusArchived} // Do not list archived items! This code
	}
...
func (impl SkillSetStorerImpl) ListAllRootStaff(ctx context.Context) (*SkillSetListResult, error) {
	f := &SkillSetListFilter{
		Role: SkillSetRoleRoot,
	}
	return impl.ListByFilter(ctx, f)
}

func (impl SkillSetStorerImpl) ListAllRetailerStaffForOrganizationID(ctx context.Context, organizationID primitive.ObjectID) (*SkillSetListResult, error) {
	f := &SkillSetListFilter{
		Role:           SkillSetRoleRetailer,
